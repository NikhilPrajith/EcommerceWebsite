...
export default function AddMoneyOverlay({open,setOpen}) {
  ...
  const [moneyToDeposit,setAmountToDeposit] = useState(0);
  const router = useRouter();
    ...
    const submitChanges = () =>{
        ...
        wallet +=parseInt(moneyToDeposit);
        console.log(wallet)
        setDoc(dataRef, {wallet:wallet }, { merge: true });
        setOpen(false);
                            ...
                            <div className="grid grid-cols-6 gap-6">
                              ...
                              <div className="col-span-6 sm:col-span-6">
                                ...
                                <input
                                  ...
                                  name="productName"
                                  id="product-name"
                                  onChange={(evt)=>setAmountToDeposit(evt.target.value)}
                                  placeholder="$"
                                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-black focus:ring-black sm:text-sm"
                                />
                              </div>
